...
class LoginResource(Resource):
	...
	def post(self):
		...
		try:
			...
			usuario = []
			usuario.append(GestorModel.encontrar_pelo_nome(data['nome']))
			usuario.append(ClienteModel.encontrar_pelo_nome(data['nome']))
			usuario.append(FornecedorModel.encontrar_pelo_nome(data['nome']))
